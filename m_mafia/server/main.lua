...
RegisterServerEvent('esx_marabunta:getStockItem')
AddEventHandler('esx_marabunta:getStockItem', function(itemName, count)
...
RegisterServerEvent('esx_marabunta:putStockItems')
AddEventHandler('esx_marabunta:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_marabunta:getFineList', function(source, cb, category)
...
ESX.RegisterServerCallback('esx_marabunta:getArmoryWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_marabunta:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_marabunta:removeArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_marabunta:buy', function(source, cb, amount)
...
ESX.RegisterServerCallback('esx_marabunta:getStockItems', function(source, cb)
